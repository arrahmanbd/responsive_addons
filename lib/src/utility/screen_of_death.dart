      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 24),
            OutlinedButton.icon(
              onPressed: () => _RDebugger.error(error),
...
/// Log levels
enum _RLogLevels { debug, info, warning, error, success }

/// Global Debug utility
class _RDebugger {
  static void log(Object? message, {_RLogLevels level = _RLogLevels.info}) {
    ...
    switch (level) {
      case _RLogLevels.debug:
        emoji = '🐞';
        color = Colors.blue;
        break;
      case _RLogLevels.info:
        emoji = '📢';
        color = Colors.green;
        break;
      case _RLogLevels.warning:
        emoji = '💡';
        color = Colors.orange;
        break;
      case _RLogLevels.error:
        emoji = '💥';
        color = Colors.red;
        break;
      case _RLogLevels.success:
        emoji = '🏆';
...
void dbug(String? message) {
  ...
  return _RDebugger.warning(highlightedMessage);
}
